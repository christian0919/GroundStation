...
class CylinderWidget(QWidget):
    ...
    def update_orientation(self, X = 0,Y = 0,Z = 0):
        ...
        roll = X  # Obtén el ángulo de balanceo desde el MPU9250
        pitch = Y  # Obtén el ángulo de inclinación desde el MPU9250
        yaw = Z  # Obtén el ángulo de dirección desde el MPU9250
